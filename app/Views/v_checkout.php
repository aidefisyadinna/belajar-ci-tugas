...
<div class="row"> 
    <div class="col-lg-6"> 
        ...
        <?= form_input(['type' => 'hidden', 'name' => 'total_harga', 
...
name="alamat"> 
        ...
        <div class="col-12"> 
            <label for="kelurahan" class="form
label">Kelurahan</label> 
            <!--<strong>select kelurahan</strong> --> 
            <select class="form-control" id="kelurahan" 
name="kelurahan" required></select> 
                ...
                <tbody> 
                    ...
                    ?> 
                            <tr> 
                                ...
                                <td><?php echo 
number_to_currency($item['price'], 'IDR') ?></td> 
                                <td><?php echo $item['qty'] ?></td> 
                                <td><?php echo 
number_to_currency($item['price'] * $item['qty'], 'IDR') ?></td> 
                            </tr> 
                    <?php
                endforeach; 
            endif; 
            ...
            <tr> 
                <td colspan="2"></td> 
                <td>Subtotal</td> 
                <td><?php echo number_to_currency($total, 
'IDR') ?></td> 
            </tr> 
            <tr> 
                <td colspan="2"></td> 
                <td>Total</td> 
                <td><span id="total"><?php echo 
number_to_currency($total, 'IDR') ?></span></td> 
            </tr> 
        </tbody> 
    </table> 
